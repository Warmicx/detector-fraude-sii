...
export const routes: Routes = [
  ...
  { path: 'busqueda', loadComponent: () => import('./pages/busqueda/busqueda.component').then(m => m.BusquedaComponent) },
  { path: 'contribuyente/:rut', loadComponent: () => import('./pages/contribuyente/contribuyente.component').then(m => m.ContribuyenteComponent) },
